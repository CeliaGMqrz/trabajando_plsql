-- 1) Accedemos con sql*plus con el usuario system.

-- 2) Creamos un nuevo usario scott, con contraseña tiger y le damos los permisos adecuados:

CREATE USER SCOTT IDENTIFIED BY TIGER DEFAULT TABLESPACE USERS TEMPORARY TABLESPACE TEMP PROFILE DEFAULT;
GRANT CONNECT, RESOURCE TO SCOTT;
ALTER USER SCOTT ACCOUNT UNLOCK;

-- 3) Salimos de la sesión entramos de nuevo, en este caso con el usuario recien creado scott, y creamos las tablas necesarias e insertamos los registros:
